<template>
    <div class="layout" style="margin-bottom:4rem ;">
        ...
        <div class="more">
            <a class="caption" href="https://www.ftvnews.com.tw/tag/奧運小學堂" target="_blank">看更多相關新聞<i
...
export default {
    ...
    methods: {
        fetchNews() {
            ...
            fetch("https://ftvapi2.ftvnews.com.tw/API/FtvGetNewsWebV2.aspx?sp=10&Cate=奧運小學堂", requestOptions)
