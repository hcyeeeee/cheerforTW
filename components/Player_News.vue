<template>
    <div class="layout" style="margin-bottom:4rem ;">
        <div class="icontitle">
                ...
                <swiper :autoplay="{ delay: 4000, disableOnInteraction: false }" :modules="modules" class="swiper-news">
                    <swiper-slide v-for="item in news" :key="item.id">
                        ...
                        <a class="link inner  newsssss"
                            :href="'https://www.ftvnews.com.tw/news/detail/' + item.ID + '?utm_source=cheerfortaiwan&utm_medium=Knowledge'"
        ...
        <div class="more">
            <a class="caption" href="https://www.ftvnews.com.tw/tag/巴黎奧運點將錄" target="_blank">看更多相關新聞<i
...
export default {
    ...
    methods: {
        fetchNews() {
            ...
            fetch("https://ftvapi2.ftvnews.com.tw/API/FtvGetNewsWebV2.aspx?sp=5&Cate=巴黎奧運點將錄", requestOptions)
